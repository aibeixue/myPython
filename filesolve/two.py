...
class mainFrame(wx.Frame):
    ...
    def _CreateToolBar(self):
        ...
        bmp_open = wx.Bitmap('25.png', wx.BITMAP_TYPE_ANY)  # 请自备按钮图片
        bmp_save = wx.Bitmap('25.png', wx.BITMAP_TYPE_ANY)  # 请自备按钮图片
        bmp_help = wx.Bitmap('25.png', wx.BITMAP_TYPE_ANY)  # 请自备按钮图片
        bmp_about = wx.Bitmap('25.png', wx.BITMAP_TYPE_ANY)  # 请自备按钮图片

        self.tb = wx.ToolBar(self)
        self.tb.SetToolBitmapSize((16, 16))

        self.tb.AddLabelTool(-1, u'打开文件', bmp_open, shortHelp=u'打开', longHelp=u'打开文件')
        self.tb.AddLabelTool(-1, u'保存文件', bmp_save, shortHelp=u'保存', longHelp=u'保存文件')
        self.tb.AddSeparator()
        self.tb.AddLabelTool(-1, u'帮助', bmp_help, shortHelp=u'帮助', longHelp=u'帮助')
        self.tb.AddLabelTool(-1, u'关于', bmp_about, shortHelp=u'关于', longHelp=u'关于...')
